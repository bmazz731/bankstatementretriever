...
export default function ActivityPage() {
  ...
  const filteredActivities = mockActivities.filter((activity) => {
    const matchesSearch = activity.account.toLowerCase().includes(searchTerm.toLowerCase()) ||
          ...
          <div className="space-y-4">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="mt-2 space-y-1 text-sm text-muted-foreground">
                          <p><strong>Account:</strong> {activity.account}</p>
                          {activity.destination && (
                            <p><strong>Destination:</strong> {activity.destination}</p>
                          )}
                          <p><strong>Time:</strong> {formatDateTime(activity.timestamp)}</p>
            ...
            {filteredActivities.length === 0 && (
              <div className="text-center py-8">
                ...
                <h3 className="mt-4 text-lg font-semibold">No matching activity</h3>
