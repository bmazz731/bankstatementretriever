...
export function DashboardStats() {
  ...
  const activeAccounts = accountData.filter(account => account.status === 'active').length
  const totalAccounts = accountData.length
  const connectedAccounts = accountData.filter(account => 
    account.connection?.status === 'active'
  ).length
  const reauthRequired = accountData.filter(account => 
