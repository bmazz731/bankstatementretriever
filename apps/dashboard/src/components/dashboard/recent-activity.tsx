            ...
            <div className="flex-shrink-0">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                ...
                <IconComponent className={`h-4 w-4 ${
                  activity.status === 'success' ? 'text-green-600 dark:text-green-300' :
                  activity.status === 'warning' ? 'text-yellow-600 dark:text-yellow-300' :
                  activity.status === 'error' ? 'text-red-600 dark:text-red-300' :
