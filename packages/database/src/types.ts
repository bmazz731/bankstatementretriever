...
export type PlanType = 'free' | 'business' | 'professional' | 'agency' | 'enterprise'
...
export type ConnectionStatus = 'active' | 'paused' | 'error' | 'reauth_required'
export type AccountStatus = 'active' | 'paused' | 'not_supported'
export type DeliveryStatus = 'pending' | 'succeeded' | 'failed' | 'retrying' | 'paused'
...
export type DestinationKind = 'google_drive' | 'dropbox' | 'onedrive' | 'webhook'
