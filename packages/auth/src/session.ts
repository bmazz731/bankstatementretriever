...
import type { UserSession, SessionStore, AuthConfig, UserWithOrg } from './types'
...
export class SessionManager {
   ...
   */
  async createSession(user: UserWithOrg, ipAddress?: string, userAgent?: string): Promise<UserSession> {
    const now = Date.now()
